...
-- CANCELF6
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("lRcancel",function(source,args)
...
-- HANDSUP
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("lRup",function(source,args)
	if not IsPauseMenuActive() then
		local ped = PlayerPedId()
...
-- POINT
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("lRpoint",function(source,args)
	if not IsPauseMenuActive() then
		local ped = PlayerPedId()
		if not IsPedInAnyVehicle(ped) and not celular and GetEntityHealth(ped) > 101 then
...
-- LIGARVEH
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("lRengine",function(source,args)
	if not IsPauseMenuActive() then
		local ped = PlayerPedId()
...
-- BIND
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("lRbind",function(source,args)
	if not IsPauseMenuActive() then
		local ped = PlayerPedId()
		if not celular and GetEntityHealth(ped) > 101 then
			if args[1] == "1" then
...
-- ACCEPT
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("lRaccept",function(source,args)
	local ped = PlayerPedId()
	if not celular and GetEntityHealth(ped) > 101 then
...
-- REJECT
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("lRreject",function(source,args)
	local ped = PlayerPedId()
	if not celular and GetEntityHealth(ped) > 101 then
...
-- KEYMAPPING
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterKeyMapping("lRcancel","Cancelar animações","keyboard","f6")
RegisterKeyMapping("lRup","Levantar as mãos","keyboard","x")
RegisterKeyMapping("lRpoint","Apontar os dedos","keyboard","b")
RegisterKeyMapping("lRengine","Ligar veículo","keyboard","z")
RegisterKeyMapping("lRbind 1","Bind 1","keyboard","1")
RegisterKeyMapping("lRbind 2","Bind 2","keyboard","2")
RegisterKeyMapping("lRbind 3","Bind 3","keyboard","3")
RegisterKeyMapping("lRbind 4","Bind 4","keyboard","4")
RegisterKeyMapping("lRbind 5","Bind 5","keyboard","5")
RegisterKeyMapping("lRbind 6","Bind 5","keyboard","6")
RegisterKeyMapping("lRbind 7","Bind 7","keyboard","7")
RegisterKeyMapping("lRbind 8","Bind 8","keyboard","8")
RegisterKeyMapping("lRbind 9","Bind 9","keyboard","9")
RegisterKeyMapping("lRbind left","Bind Left","keyboard","left")
RegisterKeyMapping("lRbind right","Bind Right","keyboard","right")
RegisterKeyMapping("lRbind up","Bind Up","keyboard","up")
RegisterKeyMapping("lRbind down","Bind Down","keyboard","down")
RegisterKeyMapping("lRaccept","Aceitar chamado","keyboard","y")
RegisterKeyMapping("lRreject","Rejeitar chamado","keyboard","u")