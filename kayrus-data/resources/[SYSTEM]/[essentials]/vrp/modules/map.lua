...
function vRP.wantedReturn(user_id)
	if wanted[user_id] ~= nil then
		TriggerClientEvent("Notify",vRP.getUserSource(user_id),"amarelo","Aguarde "..vRP.getTimers(wanted[user_id])..".",5000)
		return true
	else
		return false
	end
...
function vRP.reposeReturn(user_id)
	if repose[user_id] ~= nil then
		TriggerClientEvent("Notify",vRP.getUserSource(user_id),"amarelo","Aguarde "..vRP.getTimers(repose[user_id])..".",5000)
		return true
	else
		return false
	end
...
RegisterCommand("procurado",function(source,args,rawCommand)
	...
	if user_id then
		if wanted[user_id] ~= nil then
			TriggerClientEvent("Notify",source,"amarelo","Aguarde "..vRP.getTimers(wanted[user_id])..".",5000)
		end
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterCommand("repouso",function(source,args,rawCommand)
	...
	if user_id then
		if repose[user_id] ~= nil then
			TriggerClientEvent("Notify",source,"amarelo","Aguarde "..vRP.getTimers(repose[user_id])..".",5000)
		end
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
