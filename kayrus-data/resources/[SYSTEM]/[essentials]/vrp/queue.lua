...
Config.Language = {
	joining = "[Creative] Entrando...",
	connecting = "[Creative] Conectando...",
	err = "[Creative] Não foi possível identificar sua Steam ou Social Club.",
	_err = "[Creative] Você foi desconectado por demorar demais na fila.",
	pos = "[Creative] Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[Creative] Não foi possível adiciona-lo na fila.",
	steam = "[Creative] Você precisa estar com a Steam aberta para conectar."
}
