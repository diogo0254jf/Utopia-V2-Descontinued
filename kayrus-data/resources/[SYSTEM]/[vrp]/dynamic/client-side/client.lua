		...
		if not menuOpen then
			...
			if GetEntityHealth(ped) > 101 then
				...
				elseif paramedicService then
					exports["dynamic"]:AddButton("Medical Center","Fardamento de doutor.","emergency:presetFunctions","1","preMedic",true)
					exports["dynamic"]:AddButton("Medical Center","Fardamento de paramédico.","emergency:presetFunctions","2","preMedic",true)
					exports["dynamic"]:AddButton("Medical Center","Fardamento de paramédico interno.","emergency:presetFunctions","3","preMedic",true)
					exports["dynamic"]:AddButton("Fire Departament","Fardamento de atendimentos.","emergency:presetFunctions","4","preMedic",true)
					exports["dynamic"]:AddButton("Fire Departament","Fardamento de mergulhador.","emergency:presetFunctions","5","preMedic",true)
