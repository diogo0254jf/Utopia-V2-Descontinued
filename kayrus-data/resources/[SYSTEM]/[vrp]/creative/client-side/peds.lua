...
local pedList = {
	{ -- Ilegal NAO SEI
		distance = 30,
		coords = { 90.12,3750.65,40.78,246.62 },
		model = { 0x3D843282,"g_m_y_lost_02" },
	...
	{ -- Ilegal TICKET
		...
		model = { 0x106D9A99,"g_m_m_chicold_01" },
		anim = { "amb@lo_res_idles@","world_human_lean_male_foot_up_lo_res_base" }
	},
	{ -- Ilegal TICKET 2
		distance = 30,
	...
	{ -- Loja de Roupas 	model = { 0xB7C61032,"a_f_y_business_04" },
		distance = 15,
	...
	{ -- Caçador
		...
		model = { 0x46521A32,"cs_russiandrunk" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Caçador
		distance = 30,
