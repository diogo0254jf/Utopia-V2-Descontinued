...
function entranceHomes(homeName, v, theft)
    ...
    if v[1] == "Middle" then
		...
		table.insert(internLocates,{ v[6] + 1.36,v[7] - 14.23,1499.5,"exit","SAIR" })
    ...
    elseif v[1] == "Mansion" then
		...
		table.insert(internLocates,{ v[6] - 8.68,v[7] - 3.43,1501.0,"exit","SAIR" })
    ...
    elseif v[1] == "Trailer" then
		...
		table.insert(internLocates,{ v[6] - 1.44,v[7] - 2.02,1499.5,"exit","SAIR" })
    ...
    elseif v[1] == "Beach" then
		...
		table.insert(internLocates,{ v[6] + 0.11,v[7] - 3.68,1499.5,"exit","SAIR" })
    ...
    elseif v[1] == "Motel" then
		...
		table.insert(internLocates,{ v[6] + 4.6,v[7] - 6.36,1498.5,"exit","SAIR" })
    ...
    elseif v[1] == "Modern" then
		...
		table.insert(internLocates,{ v[6] - 1.63,v[7] - 5.94,1499.7,"exit","SAIR" })
    ...
    elseif v[1] == "Hotel" then
		...
		table.insert(internLocates,{ v[6] - 1.69,v[7] - 3.91,1499.8,"exit","SAIR" })
    ...
    elseif v[1] == "Franklin" then
		...
		table.insert(internLocates,{ v[6] - 0.47,v[7] - 5.91,1499.6,"exit","SAIR" })
	...
	elseif v[1] == "Container" then
		...
		table.insert(internLocates,{ v[6] - 0.47,v[7] - 1.38,1500.5,"exit","SAIR" })
            ...
            if not IsPedInAnyVehicle(ped) then
                ...
                for k, v in pairs(theftCoords[theftOpen]) do
                    if not theftRobberys[k] then
                        local distance = #(coords - vector3(homesList[houseOpen][5] + v[1], homesList[houseOpen][6] + v[2], 1500.0))
                        if distance <= 1.5 then
                            timeDistance = 1
                            DrawText3Ds(homesList[houseOpen][5] + v[1], homesList[houseOpen][6] + v[2], 1500.0 + v[3], "~b~E~w~   VASCULHAR")
    ...
    while true do
        ...
        if not IsPedInAnyVehicle(ped) and houseOpen ~= "" then
            ...
            for k, v in pairs(internLocates) do
                if coords["z"] <= 1450 and v[5] == "exit" then
                    ...
                    if IsControlJustPressed(1, 38) then
                        ...
                        elseif v[4] == "vault" then
                            ...
                            if autorizado and user_id then
                                ...
                                TriggerEvent("sounds:source","chest",0.2)
                                vaultMode = v[4]
                            end
...
AddEventHandler("homes:togglePropertys",function(source,args)
	...
	if casas then
		...
		for k,v in pairs(homesList) do
			blips[k] = AddBlipForRadius(v[6],v[7],v[8],5.0)
