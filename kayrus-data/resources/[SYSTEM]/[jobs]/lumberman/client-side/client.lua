...
function cRP.toggleService()
	if inService then
		...
		if GetEntityModel(ped) == GetHashKey("mp_m_freemode_01") then
			...
			SetPedComponentVariation(ped,3,35,0,2) --maos
			SetPedComponentVariation(ped,4,3,0,2) --calcas
			SetPedComponentVariation(ped,5,-1,0,2) --mochila
			SetPedComponentVariation(ped,6,52,0,2) --sapatos
			...
			SetPedComponentVariation(ped,11,41,0,2) --jaqueta
		elseif GetEntityModel(ped) == GetHashKey("mp_f_freemode_01") then
	
			SetPedComponentVariation(ped,1,-1,0,2) --mascara
			SetPedComponentVariation(ped,3,34,0,0) --maos
			SetPedComponentVariation(ped,4,74,0,2) --calcas
			SetPedComponentVariation(ped,5,-1,0,2) --mochila
			SetPedComponentVariation(ped,6,53,0,2) --sapatos
			SetPedComponentVariation(ped,7,-1,0,2) --acessorios
			SetPedComponentVariation(ped,8,-1,0,2) --camisa
			SetPedComponentVariation(ped,9,-1,0,2) --coletes
			SetPedComponentVariation(ped,10,-1,0,2) --adesivos
			SetPedComponentVariation(ped,11,109,2,2) --jaqueta
		end
		inService = true
