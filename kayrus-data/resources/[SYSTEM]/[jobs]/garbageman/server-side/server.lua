...
function cRP.paymentMethod(garbageId)
	...
	if user_id then
		...
		if parseInt(random) >= 81 then
			vRP.giveInventoryItem(user_id,"metalcan",math.random(8),true)
		elseif parseInt(random) >= 61 and parseInt(random) <= 80 then
			vRP.giveInventoryItem(user_id,"battery",math.random(8),true)
		elseif parseInt(random) >= 41 and parseInt(random) <= 60 then
			vRP.giveInventoryItem(user_id,"glassbottle",math.random(6),true)
		elseif parseInt(random) >= 26 and parseInt(random) <= 40 then
			vRP.giveInventoryItem(user_id,"elastic",math.random(5),true)
		elseif parseInt(random) >= 10 and parseInt(random) <= 25 then
			vRP.giveInventoryItem(user_id,"emptybottle",math.random(5),true)
		elseif parseInt(random) <= 5 and parseInt(random) <= 25 then
			...
			vRP.setbonusGarbageman(user_id,math.random(0,1))
		end
