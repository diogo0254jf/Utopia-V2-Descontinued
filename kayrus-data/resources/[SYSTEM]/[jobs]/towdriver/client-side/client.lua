...
-----------------------------------------------------------------------------------------------------------------------------------------
local locates = {
	{ 408.98,-1622.84,29.3,405.29,-1634.61,29.3 },
		...
		if not IsPedInAnyVehicle(ped) then
			...
			for k,v in pairs(locates) do
				...
				if distance <= 3 then
					...
					if IsControlJustPressed(1,38) and distance <= 3 and not inService then
						inService = true
						posLocate = parseInt(k)
						vehSelect = math.random(#vehicles)
						vehCoords = math.random(#coords[posLocate])
						TriggerEvent("Notify","verde","Trabalho inicializado, vá para o cliente e faça a manutenção do veículo.",5000)
